<%-- 
    Document   : ReservasTab
    Created on : 26/06/2018, 10:38:33 PM
    Author     : asus
--%>
...
<html>
    <head>
        ...
        <title>RESERVAS GERENTE</title>
        <%@include file="../WEB-INF/template/HeadViewLinks.jspf" %>
        <link rel="stylesheet" href="../css/ReservasTabGerente.css"/>
    </head>
    <body ng-app="app" ng-controller="appController">
        <div class="conteiner">
            <div class="reserva">
                <div class="busqueda">
                    <h2 style="margin: 0;">Reservas Gerente</h2>
